...
const products = [
  {
    ...
    altText: "Ταμειακή μηχανή RBS νέας γενιάς - Nastos Systems Χαλκιδική"
  },
  {
    ...
    image: pos2in1Img,
    altText: "Σύστημα All in One Ταμειακή και POS - Πώληση Χαλκιδική"
  },
  {
    ...
    image: paperRollsImg,
    altText: "Θερμικά ρολά και αναλώσιμα ταμειακών μηχανών Μουδανιά"
  },
  {
    ...
    altText: "Τεχνική υποστήριξη και διασύνδεση POS με ταμειακή"
  },
  {
    ...
    image: invoicingImg,
    altText: "Λογισμικό τιμολόγησης και διαχείρισης αποθήκης"
  },
  {
    ...
    altText: "Συστήματα ασύρματης παραγγελιοληψίας για εστίαση Χαλκιδική"
  },
  {
